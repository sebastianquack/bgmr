...
# just do once, remember with seed_id
Topic.create!(seed_id: '1', color: '#ffc800', title_de: "Schöne Orte", title_en: "Nice Places", slug_de: "schoene_orte", slug_en: "nice_places")    if Topic.where(seed_id: '1').empty?
Topic.create!(seed_id: '2', color: '#867b82', title_de: "Multicodierung", title_en: "Multicodierung", slug_de: "multicodierung", slug_en: "multicodierung")    if Topic.where(seed_id: '2').empty?
Topic.create!(seed_id: '3', color: '#e600ff', title_de: "Dynamische Landschaften", title_en: "Dynamic Landscapes", slug_de: "dynamische_landschaften", slug_en: "dynamic_landscapes")    if Topic.where(seed_id: '3').empty?
Topic.create!(seed_id: '4', color: '#00e600', title_de: "Grün Selbermachen", title_en: "DIY green", slug_de: "gruen_selbermachen", slug_en: "diy_green")    if Topic.where(seed_id: '4').empty?
Topic.create!(seed_id: '5', color: '#be0028', title_de: "Ränder der Städte", title_en: "City Borders", slug_de: "raender_der_staedte", slug_en: "city_borders")    if Topic.where(seed_id: '5').empty?
Topic.create!(seed_id: '6', color: '#0028ff', title_de: "Stadt als Ressource", title_en: "City as Ressource", slug_de: "stadt_als_ressource", slug_en: "city_ressource")    if Topic.where(seed_id: '6').empty?
Topic.create!(seed_id: '7', color: '#00deff', title_de: "Transformation", title_en: "Transformation", slug_de: "transformation", slug_en: "transformation")    if Topic.where(seed_id: '7').empty?
Topic.create!(seed_id: '8', color: '#00c8aa', title_de: "Klimaangepasste Stadt", title_en: "Climate Adjusted City", slug_de: "klimaangepasste_stadt", slug_en: "climate_adjusted_city")    if Topic.where(seed_id: '8').empty?
Topic.create!(seed_id: '9', color: '#8e8200', title_de: "Grau-grüne Infrastruktur", title_en: "Grey-Green-Infrastructure", slug_de: "graugruene_infrastruktur", slug_en: "grey_green_infrastructure")    if Topic.where(seed_id: '9').empty?
Topic.create!(seed_id: '10', color: '#ff6400', title_de: "Bildungslandschaften", title_en: "Educational Landscapes", slug_de: "bildungslandschaften", slug_en: "educational_landscapes")    if Topic.where(seed_id: '10').empty?
