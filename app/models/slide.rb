class Slide < ActiveRecord::Base
	...
	has_attached_file :image, 
		 styles: { large: "800x800>", zoom: "5501x5501>", plan_w2000: "2000x2000>", plan_w1000: "1000x1000>", plan_w500: "500x500>", w2000: "2000x2000>", w1000: "1000x1000>", w500: "500x500>", medium: "600x600>", thumb: "100x100>" }, default_url: "/assets/:style/missing.png",
		 :convert_options => {
			:large      => "-quality 90",
			:w2000      => "-quality 90",
			:w1000      => "-quality 90",
