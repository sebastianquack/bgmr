...
(function(global, factory) {
	...
	Panzoom.prototype = {
		...
		resetDimensions: function() {
			...
			var height_factor = img.naturalHeight / img.height
			var width_factor = img.naturalWidth / img.width


			console.log("HERE -->",dims.height, height_factor)

			this.dimensions = {
				width: dims.width * width_factor,
				height: dims.height * height_factor,
		...
		setMatrix: function(matrix, options) {
			...
			if (contain) {
				...
				console.log(zoomAspectH, zoomAspectW, conHeight, height)
